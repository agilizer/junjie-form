package com.agilemaster.findoil.consants;


public interface FindOilConstants {
	String SUCCESS="success";
	String DATA="data";
	String CON_SITE_NAME="siteName";
	String CON_SITE_URL="siteUrl";
	String CON_FOOTER_KEY="footerHtml";
	...
	String PRODUCT_FILE_STORE_PATH="/product/";
	
	int AREA_LEVEL_PROVINCE=1;
